...
def get_avg_distance(list1, list2, indexList):
    if set(list1) == set(list2):
        ...
        for class1 in list1:
            ...
            for class2 in list2:
                ...
                sum_distance = sum_distance + distance_calculated
                dcount = dcount+1

        avg_distance = sum_distance/dcount
...
def get_init_matrix(sample, classList):
    ...
    for i in range(len(classList)):
        ...
        for j in classList:
            distance_calculated = get_avg_distance(classList[i], j, sample)
