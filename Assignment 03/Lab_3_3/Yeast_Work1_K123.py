...
#--------------------------------------------------- print ------------------------------------------------------------
print("Number of correctly classified instances for k = "+ str(k1)+" : "+str(correct1))
print("Number of correctly classified instances for k = "+ str(k2)+" : "+str(correct2))
print("Number of correctly classified instances for k = "+ str(k3)+" : "+str(correct3))
